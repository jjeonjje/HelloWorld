...
*마틴파울러의 리팩토링 책의 6장부터 12장 까지 리팩토링 기법 및 예제를 정리한 저장소 입니다.*

---
## 1. 메서드 정리
* [메서드 추출](chapter06/1.ExtractMethod.md)
* [메서드 내용 직접 삽입](chapter06/2.InlineMethod.md)
* [임시변수 내용 직접 삽입](chapter06/3.InlineTemp.md)
* [임시변수를 메서드 호출로 전환](chapter06/4.ReplaceTempWithQuery.md)
* [직관적 임시변수 사용](chapter06/5.IntroduceExplainingVariable.md)
* [임시변수 분리](chapter06/6.SplitTemporaryVariable.md)
